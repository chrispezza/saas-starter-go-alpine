...
func homeSurfaces() []surface {
	return []surface{
		...
		},
		{
			...
			Title:       "Flashcards",
			Description: "Wrong quiz answers become saveable flashcards: review, flip, mark known, delete — per-user CRUD through the RLS-scoped repositories, plus an isolation check that runs your own query as a stranger.",
		},
		{
			Href:        "/dashboard",
			Title:       "Dashboard",
